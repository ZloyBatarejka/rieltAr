...
import { StayTransactionDto } from './stay-transaction.dto';

export class StayDetailDto {
  ...
  @ApiProperty({
    type: [StayTransactionDto],
    description: 'Транзакции, связанные с заездом',
  })
  transactions: StayTransactionDto[];
}
